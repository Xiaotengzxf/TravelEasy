...
@implementation XZCalendarModel
+(XZCalendarModel *)calendarDayWithYear:(NSUInteger)year month:(NSUInteger)month day:(NSUInteger)day
{
    XZCalendarModel *calendarDay = [[XZCalendarModel alloc] init];//初始化自身
...
//判断是不是同一天
- (BOOL)isEqualTo:(XZCalendarModel *)day
{
